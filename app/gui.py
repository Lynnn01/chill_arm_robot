...
AUTO_PROMPTS = [
    ...
    "จัดโต๊ะให้เรียบร้อยหน่อย",
    "เล่นเป่ายิงฉุบกัน!",
    "โบกมือทักทายแบบอีสานม่วนๆ",
    "หากล่องสีแดงไปวางตรงพื้นที่สีฟ้า",
    "แกะกล่องที่โดนทับอยู่มาโชว์หน่อย",
    "ทำท่าก้มหัวคำนับแบบหล่อๆ",
    "โชว์ของทั้งหมดที่มีบนโต๊ะหน่อย",
    "ขยับตัวเต้นฉลองหน่อย!"
]

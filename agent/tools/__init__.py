...
agent_tools = [move_to, grab_object, move_around, show_object, execute_python_code, move, rotate_gripper, describe_scene, dance_celebrate, gesture, scan_object, give_to_person, sort_by_color, unstack_and_grab]

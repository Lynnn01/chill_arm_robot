...
@function_tool
def move_to(target_coord: list[float] = None, target_name: str = None, target_height: int = None, smart_place: bool = False) -> str:
    """
    ...
    Args:
        ...
        target_height: The height to release the object (optional, auto-calculated for table or stacking if omitted).
